...
module.exports = {
    posts: {
        ...
        feature_image_width: {type: 'string', maxlength: 10, nullable: true},
        feature_image_height: {type: 'string', maxlength: 10, nullable: true},
        ...
        views: {type: 'integer', nullable: false, unsigned: true, defaultTo: 0}
    },
    posts_meta: {
        id: {type: 'string', maxlength: 24, nullable: false, primary: true},
